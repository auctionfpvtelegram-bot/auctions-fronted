  ...
  return (
    <div style={{ padding: '16px', background: '#f5f5f5', minHeight: '100vh', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
        ...
        <button onClick={() => setAdminScreen('users')} style={{ width: '100%', height: '48px', background: '#c62828', color: '#fff', border: 'none', borderRadius: '12px', fontWeight: '600', cursor: 'pointer', fontSize: '14px' }}>🚫 Блокировка пользователей</button>
      </div>
